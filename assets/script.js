document.addEventListener("DOMContentLoaded", function(){
    function initSlider(containerSelector){
        ...
        sliders.appendChild(firstSlideClone);
        const slidesPerPage=containerSelector==='.bg-team'&&window.matchMedia('(min-width:450px) and (max-width:800px)').matches?2:1;
        ...
        function updateSlider(){
            ...
            if(currentSlide>=totalPages){
                setTimeout(()=>{
                    ...
                    setTimeout(()=>{
                        sliders.style.transition='margin-left 0.8s ease';
                    },50);
                },800);
            }
        }
